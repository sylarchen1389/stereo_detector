...
WEIGHTS_FILE_PATH = "/media/sylar/DATA/Code_D/model/darknet/backup/HIT/yolov3-voc_HIT_3000.backup"
CFG_FILE_PATH = "/media/sylar/DATA/Code_D/model/darknet/cfg/yolov3-voc_HIT.cfg"
...
def main():
    ...
    output_file_path = 'backup/yolov3.onnx'
